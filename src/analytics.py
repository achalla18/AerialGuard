...
class FlightAnalytics:
    ...
    def compute_risk_score(
        ...
        for a in analytics.values():
            ...
            score += int(a.get("approach_aggressiveness", 0) * 10)
